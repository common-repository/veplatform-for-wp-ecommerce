...
> This plugin requires <a href="https://wordpress.org/plugins/wp-e-commerce/" rel="nofollow">WP eCommerce plugin</a>.
...
* WP eCommerce v3.10.0 (https://wordpress.org/plugins/wp-e-commerce/)
...
2.  Select “Plugins > Add New” and upload the VePlatform plugin .zip file.
3.  Click “Install Now”.
4.  Click the “Activate Plugin” button.
5.  Once the installation is complete, you will be able to find VePlatform in your plugins page and in the Products section of the menu. 
6.  At this point, you can check if the tag is generated in your web store. 
7.  On the VePlatform settings page you'll find more info about your account and your apps.
8.  The thank you page is displayed.
9.  Installation is complete and you can check if the pixel is generated in your web store.

If you need further assistance or advice please contact us at: wpecommerce@veinteractive.com 
